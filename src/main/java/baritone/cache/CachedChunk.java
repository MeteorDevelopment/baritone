...
public final class CachedChunk {
    ...
    // 26.2 consolidated the 16 colored shulker boxes and 16 colored beds into ColorCollections
    // (Blocks.DYED_SHULKER_BOX / Blocks.BED), so they are added via asList() instead of individually.
    public static final ImmutableSet<Block> BLOCKS_TO_KEEP_TRACK_OF = ImmutableSet.<Block>builder()
            .add(
                    Blocks.ENDER_CHEST,
                    Blocks.FURNACE,
                    Blocks.CHEST,
